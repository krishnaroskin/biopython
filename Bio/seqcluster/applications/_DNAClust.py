        ...
        self.parameters = \
           [
            _Option(["--similarity", "s", "similarity"],
                    ...
                    equate=False),
            _Option(["--predetermined-cluster-centers", "p", "predeterminedclustercenters"],
                    "file containing predetermined cluster centers",
                    filename=True,
                    equate=False),
            _Switch(["--recruit-only", "r", "recruitonly"],
            ...
            _Switch(["--left-gaps-allowed", "l", "leftgapsallowed"],
                    "allow gaps on the left of shorter string in alignment"),
            _Option(["--k-mer-length", "k", "kmerlength"],
                    "Maximum length of the k-mers used for filtering.",
                    filename=False,
                    checker_function=lambda x: isinstance(x, int),
                    equate=False),
            _Switch(["--approximate-filter", "approximatefilter"],
                    "Use fast but approximate k-mer filter"),
            _Switch(["--no-k-mer-filter", "nokmerfilter"],
                    "disable k-mer filter"),
            _Switch(["--no-overlap", "nooverlap"],
